// SimpleFOC football launcher - 300mm launch tube + embedded outrunner integrated mount layout v1.2k
// Tightened from v1.2 per PM/new reference image:
// - launch tube length is 300mm per owner update; tube is the ball guide, not the motor shaft
// - 3 OUTRUNNER cans are embedded into the tube wall pockets around the outside
...
rubber_sleeve_t           = 1.5;
spin_clearance            = 3;
rotor_clearance_min       = 3.0;      // min target clearance around spinning outrunner can
wire_channel_w            = 13;
wire_channel_h            = 8;
wire_channel_len          = 52;
tool_access_d            = 11;        // screwdriver / hex key access envelope
...
motor_station_z           = 85;      // motor cluster sits near outlet section of 300mm tube
active_contact_zone_len   = 90;      // embedded motor/contact zone; rest remains guide tube
outlet_service_len        = 65;
mount_45_pitch           = 45;
mount_45_hole_d          = 5.5;
mount_45_boss_d          = 13;
mount_45_pad_w           = 74;
...
pocket_tangent_w          = motor_len + 26;   // wider photo-like motor pocket blended into tube
pocket_z_len              = motor_d + 24;    // taller pocket/end-plate envelope
