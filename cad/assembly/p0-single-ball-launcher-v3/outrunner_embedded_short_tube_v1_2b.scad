// SimpleFOC football launcher - embedded short-tube 3-outrunner layout v1.2b
// Tightened from v1.2 per PM/new reference image:
// - center is a SHORT tube/ring, not a long launch barrel
...
// - launch direction is the resultant force vector from three embedded motors, not only the tube outlet axis
// Units: mm
...
show_launch_axis          = true;   // visualizes resultant force / launch vector baseline
...
// ---------- Notes ----------
// v1.2b removes protective shield expression and emphasizes three embedded motors in the short launch tube.
// Launch direction is treated as the three-motor resultant force vector; tube axis remains the structural guide reference.
