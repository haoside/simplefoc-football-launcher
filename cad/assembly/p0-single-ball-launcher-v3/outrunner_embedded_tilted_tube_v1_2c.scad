// SimpleFOC football launcher - embedded tilted 3-outrunner direct-launch layout v1.2c
...
// - launch direction is upward direct launch from tilted three-motor resultant force
// Units: mm
...
short_tube_wall           = 9;
launch_tilt_deg           = 18;      // v1.2c: three embedded motors tilted for direct upward launch
...
// ---------- Notes ----------
// v1.2c tilts the embedded three-motor station for direct upward launch.
