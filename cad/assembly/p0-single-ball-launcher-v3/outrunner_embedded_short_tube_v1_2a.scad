// SimpleFOC football launcher - embedded short-tube 3-outrunner layout v1.2a
...
// - launch direction is still defined by the short tube outlet axis (+Z)
// Units: mm
...
// ---------- Notes ----------
// v1.2a is the tightened baseline: short tube/ring center, 3 embedded/clamped outrunners, outlet-axis launch direction.
// Use this for geometry interference and motion-envelope simulation before adding ballistic/RPM complexity.
