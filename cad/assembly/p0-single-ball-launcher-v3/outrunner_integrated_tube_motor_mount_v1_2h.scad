// SimpleFOC football launcher - integrated launch tube + 3-motor mount engineering layout v1.2h
...
// - engineering focus: launch tube, motor pockets, end plates, ribs, wire exits and tool access are one orange structural body
// Units: mm
...
module short_tube_body() {
  difference() {
    union() {
      ...
      if (integrated_monocoque) integrated_motor_pocket_body();
