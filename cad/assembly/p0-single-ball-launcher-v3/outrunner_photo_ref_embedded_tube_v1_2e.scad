// SimpleFOC football launcher - photo-reference embedded 3-outrunner launch tube layout v1.2e
...
// - photo reference: center short launch tube opening, three outrunners embedded into orange tube-side cradle windows
// Units: mm
...
photo_ref_embedded        = true;    // v1.2e: motors are embedded into tube-side cradle, not external add-ons
