// SimpleFOC football launcher - football-scale 300mm tube + embedded outrunner integrated mount layout v1.2l
// Tightened from v1.2 per PM/new reference image:
// - proportionally scaled to project football requirement: 220mm ball, 300mm guide tube
// - 3 6354 outrunner cans are embedded from the OUTSIDE tube wall, scaled from reference geometry
