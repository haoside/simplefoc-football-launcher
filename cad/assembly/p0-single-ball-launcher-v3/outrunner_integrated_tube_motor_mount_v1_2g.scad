// SimpleFOC football launcher - integrated launch tube + 3-motor mount monocoque layout v1.2g
...
// - integrated monocoque: launch tube, motor pockets, end plates and ribs are one orange structural body
// Units: mm
...
integrated_monocoque      = true;    // v1.2g: tube and three motor mounts are one integrated structure
