// P0 single-ball football launcher outer-rotor assembly placeholder v7 (parametric)
// Units: mm
...
// - ring connection ears included in the stronger web sectors
// - simple link plates connect ring ears toward the outer head carrier
...
ear_t = 12;
ear_hole_d = 6.6;
frame_stub_l = 70;            // simple outer support stub length
frame_stub_w = 22;
frame_stub_t = 10;
link_plate_w = 26;
link_plate_t = 8;
