...
- Node 方案：P0-A 台架每个轮子 1 块 `B-G431B-ESC1`；P0-B 实球发射需切到高电流 SimpleFOC 驱动，不能把 B-G431B-ESC1 直接当最终动力板
- Feedback：P0 优先 Hall，增强方案可切 `AS5048A`
- Power：P0-A 低速台架按 `24V`；P0-B 现场按 `24V LiFePO4 40~60Ah` 与工程复核后的保护链路
...
- `docs/mechanical/MANUFACTURING_PRIORITY_V1.md`
